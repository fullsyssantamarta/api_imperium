                        ...
                        <tr>
                            ...
                            @if($item->identification_number && $item->first_name && $item->surname && $item->health_type_document_identification_id)
                                <td>
                                    ...
                                    <p style="font-size: 8px">Tipo Documento: {{optional($item->health_type_document_identification)->name}}</p>
                                    <p style="font-size: 8px">Tipo Usuario: {{optional($item->health_type_user)->name}}</p>
                                </td>
                            @else
                                <td>
