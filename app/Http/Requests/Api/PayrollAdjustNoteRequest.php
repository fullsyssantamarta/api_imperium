...
class PayrollAdjustNoteRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'type_note' => 'required|exists:type_payroll_adjust_notes,id',

            // Replace Predecessor

            'predecessor' => 'required|array',
            'predecessor.predecessor_number' => 'required|integer',
            'predecessor.predecessor_cune' => 'required|string',
            'predecessor.predecessor_issue_date' => 'required|date_format:Y-m-d',
...
//            // Period
//            'period' => 'nullable|required_if:type_note,1|array',
//            'period.admision_date' => 'nullable|required_if:type_note,1|date_format:Y-m-d',
//            'period.retirement_date' => 'nullable|required_if:type_note,1|date_format:Y-m-d',
//            'period.settlement_start_date' => 'nullable|required_if:type_note,1|date_format:Y-m-d',
//            'period.settlement_end_date' => 'nullable|required_if:type_note,1|date_format:Y-m-d',
//            'period.worked_time' => 'nullable|required_if:type_note,1|numeric',
//            'period.issue_date' => 'nullable|required_if:type_note,1|date_format:Y-m-d',
            ...
            // Worker
            'worker' => 'nullable|required_if:type_note,1|array',
            'worker.type_worker_id' => 'nullable|required_if:type_note,1|exists:type_workers,id',
            'worker.sub_type_worker_id' => 'nullable|required_if:type_note,1|exists:sub_type_workers,id',
            'worker.payroll_type_document_identification_id' => 'nullable|required_if:type_note,1|exists:payroll_type_document_identifications,id',
            ...
            'worker.address' => 'nullable|required_if:type_note,1|string',
            'worker.email' => 'nullable|string|email',
            'worker.integral_salarary' => 'nullable|required_if:type_note,1|boolean',
            'worker.salary' => 'nullable|required_if:type_note,1|numeric',
            ...
            // Payment
            'payment' => 'nullable|required_if:type_note,1|array',
            'payment.payment_method_id' => 'nullable|required_if:type_note,1|exists:payment_methods,id',
//            'payment.bank_name' => 'nullable|required_if:type_note,==,1|required_if:payment.payment_method_id,2,3,4,5,6,7,21,22,30,31,42,45,46,47,|string',
//            'payment.account_type' => 'nullable|required_if:type_note,1|required_if:payment.payment_method_id,2,3,4,5,6,7,21,22,30,31,42,45,46,47,|string',
//            'payment.account_number' => 'nullable|required_if:type_note,1|required_if:payment.payment_method_id,2,3,4,5,6,7,21,22,30,31,42,45,46,47,|string',
            'payment.bank_name' => 'nullable|required_if:type_note,==,1|string',
            'payment.account_type' => 'nullable|required_if:type_note,1|string',
            'payment.account_number' => 'nullable|required_if:type_note,1|string',

            // Payment Dates
            'payment_dates' => 'nullable|required_if:type_note,1|array',
            'payment_dates.*.payment_date' => 'nullable|required_if:type_note,1|date_format:Y-m-d',

            // Accrued
            'accrued' => 'nullable|required_if:type_note,1|array',
            'accrued.worked_days' => 'nullable|required_if:type_note,1|numeric|digits_between:1,2',
            'accrued.salary' => 'nullable|required_if:type_note,1|numeric',
            ...
            'accrued.accrued_total' => 'nullable|required_if:type_note,1|numeric',

            // Deductions
            'deductions' => 'nullable|required_if:type_note,1|array',
            'deductions.eps_type_law_deductions_id' => 'nullable|required_if:type_note,1|exists:type_law_deductions,id',
            'deductions.eps_deduction' => 'nullable|required_if:type_note,1|numeric',
            'deductions.pension_type_law_deductions_id' => 'nullable|required_if:type_note,1|exists:type_law_deductions,id',
            'deductions.pension_deduction' => 'nullable|required_if:type_note,1|numeric',
            ...
            'deductions.deductions_total' => 'nullable|required_if:type_note,1|numeric',
        ];
    }
}
